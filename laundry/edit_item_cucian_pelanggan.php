...
if (isset($_POST['simpan'])) {
  ...
  if (empty($ukuran) || empty($warna) || empty($jumlahItem)) {
    ...
    // Mengalihkan kembali ke halaman edit_permintaan_cucian_pelanggan.php setelah item cucian diperbarui
...
if (isset($_POST['hapus'])) {
  ...
  if ($jumlahTransaksi > 0) {
    ...
    // Mengalihkan kembali ke halaman edit_permintaan_cucian_pelanggan.php setelah item cucian dihapus
    header("Location: edit_permintaan_cucian_pelanggan.php?no_cucian=$noCucian");
    exit;
  }
}
