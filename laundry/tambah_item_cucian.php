...
if (isset($_POST['tambah'])) {
  ...
  if (empty($idItem) || empty($ukuran) || empty($warna) || empty($jumlahItem)) {
    ...
    // Mengalihkan kembali ke halaman edit_permintaan_cucian.php setelah item cucian ditambahkan
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="text-right">
            <a href="edit_permintaan_cucian.php?no_cucian=<?php echo $noCucian; ?>" class="btn btn-primary">Kembali ke Daftar Item Cucian</a>
          </div>
        </div>
      </div>
      <div class="row">
