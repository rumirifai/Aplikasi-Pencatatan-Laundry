...
if (isset($_POST['simpan'])) {
        ...
        // Mengalihkan kembali ke halaman permintaan_cucian_pelanggan.php setelah permintaan cucian diperbarui
        header("Location: permintaan_cucian_pelanggan.php");
        exit;
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="text-right">
                        <a href="permintaan_cucian_pelanggan.php" class="btn btn-primary">Kembali ke Daftar Permintaan Cucian</a>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <form action="" method="POST">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="id_pelanggan" name="id_pelanggan" disabled >
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="id_prioritas" name="id_prioritas" disabled>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="tgl_masuk" name="tgl_masuk"
                                value="<?php echo $permintaan['tgl_masuk']; ?>"readonly>
                        </div>
                        <div class="form-group">
                            <label for="tgl_selesai">Tanggal Selesai</label>
                            <input type="date" class="form-control" id="tgl_selesai" name="tgl_selesai"
                                value="<?php echo $permintaan['tgl_selesai']; ?>"readonly>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="id_status_cucian" name="id_status_cucian" disabled>
                ...
                <div class="col-lg-6">
                        ...
                        <tbody>
                            ...
                            while ($row = mysqli_fetch_assoc($resultItem)):
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="edit_item_cucian_pelanggan.php?id=<?php echo $row['no_itemCucian']; ?>&no_cucian=<?php echo $noCucian; ?>"
                                            class="btn btn-sm btn-primary edit-btn">Edit</a>

                                        <a href="hapus_item_cucian_pelanggan.php?id=<?php echo $row['no_itemCucian']; ?>&no_cucian=<?php echo $noCucian; ?>"
                    ...
                    <div class="text-right">
                        <a href="tambah_item_cucian_pelanggan.php?no_cucian=<?php echo $noCucian; ?>"
