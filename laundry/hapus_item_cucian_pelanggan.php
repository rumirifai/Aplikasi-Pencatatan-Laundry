...
if (mysqli_num_rows($resultTransaksi) > 0) {
    ...
    header("Location: edit_permintaan_cucian_pelanggan.php?no_cucian=$noCucian&error=Permintaan cucian tidak dapat dihapus karena sudah terhubung dengan transaksi.");
    exit;
}
...
// Alihkan kembali ke halaman edit_permintaan_cucian_pelanggan setelah item cucian dihapus
